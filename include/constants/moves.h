...
// Pokescape
#define MOVE_CHAOTIC_RIFT       (MOVES_COUNT_GEN9 + 1)
#define MOVE_SARADOMIN_STRIKE   (MOVES_COUNT_GEN9 + 2)
#define MOVE_SWORD_STRIKE       (MOVES_COUNT_GEN9 + 3)
#define MOVE_SLICE_DICE         (MOVES_COUNT_GEN9 + 4)
#define MOVE_ZAMORAK_FLAMES     (MOVES_COUNT_GEN9 + 5)
#define MOVE_GUTHIX_CLAWS       (MOVES_COUNT_GEN9 + 6)
#define MOVE_POLYPORE_STRIKE    (MOVES_COUNT_GEN9 + 7)
#define MOVE_ICE_BARRAGE        (MOVES_COUNT_GEN9 + 8)
#define MOVE_BLOOD_BARRAGE      (MOVES_COUNT_GEN9 + 9)
#define MOVE_VENGEANCE          (MOVES_COUNT_GEN9 + 10)
#define MOVE_ARMADYL_STORM      (MOVES_COUNT_GEN9 + 11)
#define MOVE_TUMEKEN_STORM      (MOVES_COUNT_GEN9 + 12)
#define MOVE_SMOKE_BARRAGE      (MOVES_COUNT_GEN9 + 13)
#define MOVE_SHADOW_BARRAGE     (MOVES_COUNT_GEN9 + 14)
#define MOVE_TELEGRAB           (MOVES_COUNT_GEN9 + 15)
#define MOVE_FREE_STUFF         (MOVES_COUNT_GEN9 + 16)
#define MOVE_BANDOS_FURY        (MOVES_COUNT_GEN9 + 17)
#define MOVE_ZAROS_BECKON       (MOVES_COUNT_GEN9 + 18)
#define MOVE_SEREN_SHINE        (MOVES_COUNT_GEN9 + 19)
#define MOVE_GODLESS_REBEL      (MOVES_COUNT_GEN9 + 20)
#define MOVE_TZ_TOK_ZEK         (MOVES_COUNT_GEN9 + 21)
#define MOVE_BAWK_BAWK          (MOVES_COUNT_GEN9 + 22)
#define MOVE_OVERLOAD           (MOVES_COUNT_GEN9 + 23)
#define MOVE_TELE_BLOCK         (MOVES_COUNT_GEN9 + 24)
#define MOVE_DRAGONFIRE         (MOVES_COUNT_GEN9 + 25)
#define MOVE_SILVERLIGHT        (MOVES_COUNT_GEN9 + 26)
#define MOVE_DARKLIGHT          (MOVES_COUNT_GEN9 + 27)
#define MOVE_ARCLIGHT           (MOVES_COUNT_GEN9 + 28)
#define MOVE_EMBERLIGHT         (MOVES_COUNT_GEN9 + 29)
#define MOVE_IBAN_BLAST         (MOVES_COUNT_GEN9 + 30)
#define MOVE_LIQUEFY            (MOVES_COUNT_GEN9 + 31)
#define MOVE_CONFUSE            (MOVES_COUNT_GEN9 + 32)
#define MOVE_ANALYSE            (MOVES_COUNT_GEN9 + 33)
#define MOVE_ALCHEMY            (MOVES_COUNT_GEN9 + 34)
#define MOVE_SNARE              (MOVES_COUNT_GEN9 + 35)
#define MOVE_ENTANGLE           (MOVES_COUNT_GEN9 + 36)
#define MOVE_PUNCTURE           (MOVES_COUNT_GEN9 + 37)
#define MOVE_ICE_RUSH           (MOVES_COUNT_GEN9 + 38)
#define MOVE_ICE_BURST          (MOVES_COUNT_GEN9 + 39)
#define MOVE_ICE_BLITZ          (MOVES_COUNT_GEN9 + 40)
#define MOVE_BLOOD_RUSH         (MOVES_COUNT_GEN9 + 41)
#define MOVE_BLOOD_BURST        (MOVES_COUNT_GEN9 + 42)
#define MOVE_BLOOD_BLITZ        (MOVES_COUNT_GEN9 + 43)
#define MOVE_SMOKE_RUSH         (MOVES_COUNT_GEN9 + 44)
#define MOVE_SMOKE_BURST        (MOVES_COUNT_GEN9 + 45)
#define MOVE_SMOKE_BLITZ        (MOVES_COUNT_GEN9 + 46)
#define MOVE_SHADOW_RUSH        (MOVES_COUNT_GEN9 + 47)
#define MOVE_SHADOW_BURST       (MOVES_COUNT_GEN9 + 48)
#define MOVE_SHADOW_BLITZ       (MOVES_COUNT_GEN9 + 49)
#define MOVE_CURE_GROUP         (MOVES_COUNT_GEN9 + 50)
#define MOVE_SMITE              (MOVES_COUNT_GEN9 + 51)
#define MOVE_RETRIBUTION        (MOVES_COUNT_GEN9 + 52)
#define MOVE_MISCHIEF           (MOVES_COUNT_GEN9 + 53)
#define MOVE_RODENT_BITE        (MOVES_COUNT_GEN9 + 54)
#define MOVE_CALL_TO_ARMS       (MOVES_COUNT_GEN9 + 55)
#define MOVE_PETRIFYING_GAZE    (MOVES_COUNT_GEN9 + 56)
#define MOVE_WIND_STRIKE        (MOVES_COUNT_GEN9 + 57)
#define MOVE_WIND_BLAST         (MOVES_COUNT_GEN9 + 58)
#define MOVE_WIND_WAVE          (MOVES_COUNT_GEN9 + 59)
#define MOVE_WIND_SURGE         (MOVES_COUNT_GEN9 + 60)
#define MOVE_CRUMBLE_UNDEAD     (MOVES_COUNT_GEN9 + 61)
#define MOVE_CURE_PLANT         (MOVES_COUNT_GEN9 + 62)
#define MOVE_BACON_BLAST        (MOVES_COUNT_GEN9 + 63)
#define MOVE_TITANS_CONSTITUTION (MOVES_COUNT_GEN9 + 64)
#define MOVE_CONSPIRACY         (MOVES_COUNT_GEN9 + 65)
#define MOVE_COMMITTEE_STRIKE   (MOVES_COUNT_GEN9 + 66)
#define MOVE_CARAPACE_HARDEN    (MOVES_COUNT_GEN9 + 67)
#define MOVE_SHARKBREW          (MOVES_COUNT_GEN9 + 68)
#define MOVE_EXCALIBUR          (MOVES_COUNT_GEN9 + 69)
#define MOVE_SNELM_SHOWOFF      (MOVES_COUNT_GEN9 + 70)
#define MOVE_ENERGY_DRAIN       (MOVES_COUNT_GEN9 + 71)
#define MOVE_BERSERK            (MOVES_COUNT_GEN9 + 72)
#define MOVE_DEFIANCE           (MOVES_COUNT_GEN9 + 73)
#define MOVE_DEFLECT            (MOVES_COUNT_GEN9 + 74)
...
#define FIRST_POKESCAPE_MOVE    MOVE_CHAOTIC_RIFT
#define LAST_POKESCAPE_MOVE     MOVE_DIVINERAGE

#define MOVES_COUNT_POKESCAPE  (LAST_POKESCAPE_MOVE + 1)

#define MOVES_COUNT             MOVES_COUNT_POKESCAPE
