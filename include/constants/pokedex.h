...
//POKESCAPE
    ...
    NATIONAL_DEX_BLOODVELD_INSATIABLE_PHYSICAL,
    NATIONAL_DEX_BLOODVELD_RSHD,
    NATIONAL_DEX_BLOODVELD_MUTATED,
    NATIONAL_DEX_BLOODVELD_INSATIABLE_SPECIAL,
    NATIONAL_DEX_REAVER,
    ...
    NATIONAL_DEX_BROAV_ZOMBIE_FORM,
    NATIONAL_DEX_IMPLING_EASTER_FORM,
    NATIONAL_DEX_IMPLING_SNOW_FORM,
    NATIONAL_DEX_IMPLING_WANDERING_FORM,
    NATIONAL_DEX_IMPLING_GHOST_FORM,
    NATIONAL_DEX_VORKATH,
    NATIONAL_DEX_FOX_PYRE,
    NATIONAL_DEX_FOX_RECRUITMENTDRIVE,
    NATIONAL_DEX_FOX_FENNEC,
    NATIONAL_DEX_SALAMANDER_TECU,
    NATIONAL_DEX_JERBOA,
    NATIONAL_DEX_JERBOA_EMBERTAIL,
    NATIONAL_DEX_ANTELOPE_SUNLIGHT_FORM,
    NATIONAL_DEX_ANTELOPE_MOONLIGHT_FORM,
    NATIONAL_DEX_CAPYBARA,
    NATIONAL_DEX_CAPYBARA_ORANGE,
    NATIONAL_DEX_ENTLING,
    NATIONAL_DEX_PIGGLES,
    NATIONAL_DEX_WOLPERTINGER_MEGA_FORM,
    NATIONAL_DEX_FLESH_SPOILER_NAKED_FORM,
    NATIONAL_DEX_FLESH_SPOILER_SPAWNLING,
    NATIONAL_DEX_CAUSTIC_GAZER,
    NATIONAL_DEX_IRIS_STALKER,
    NATIONAL_DEX_ANIMATED_BOOK,
    NATIONAL_DEX_TOME_OF_STRENGTH,
    NATIONAL_DEX_TOME_OF_RANGED,
    NATIONAL_DEX_TOME_OF_MAGIC,
    NATIONAL_DEX_LUMINESCENT_ICEFIEND,
    NATIONAL_DEX_WARPED_GALUGA,
    NATIONAL_DEX_SUBMASTYX,
    NATIONAL_DEX_PARAMASTYX,
    NATIONAL_DEX_ARCHAEMASTYX,
    NATIONAL_DEX_DROMOMASTYX,
    NATIONAL_DEX_SPINOMASTYX,
    NATIONAL_DEX_GALLIMASTYX,
    NATIONAL_DEX_STEGOMASTYX,
    NATIONAL_DEX_MEGAMASTYX,
    NATIONAL_DEX_JELLY_ALTERNATE_FORM,
    NATIONAL_DEX_JELLY_DUNGEONEERING_FORM,
    NATIONAL_DEX_JELLY_TROLLWEISS_FORM,
    NATIONAL_DEX_JELLY_VITREOUS_FORM,
    NATIONAL_DEX_JELLY_WARPED_VITREOUS_FORM,
    NATIONAL_DEX_MOTH_SUNLIGHT_FORM,
    NATIONAL_DEX_MOTH_MOONLIGHT_FORM,
    NATIONAL_DEX_STONE_OF_JAS_MEGA_FORM,
    NATIONAL_DEX_SPIRIT_WARRIOR,
    NATIONAL_DEX_SPIRIT_RANGER,
    NATIONAL_DEX_SPIRIT_MAGE,
    NATIONAL_DEX_ESSLING,
    NATIONAL_DEX_ESSHOUND,
    NATIONAL_DEX_ESSWRAITH,
    NATIONAL_DEX_HARPY_EAGLE,
    NATIONAL_DEX_REBORN_WARRIOR,
    NATIONAL_DEX_REBORN_RANGER,
    NATIONAL_DEX_REBORN_MAGE,
    NATIONAL_DEX_JAGUAR_ORANGE_FORM,
    NATIONAL_DEX_JAGUAR_BLACK_FORM,
    NATIONAL_DEX_TORTLE,
    NATIONAL_DEX_COCKATRICE_OSRS_FORM,
    NATIONAL_DEX_COCKATHRICE,
    NATIONAL_DEX_COCKATRICE_MOONLIGHT,
    NATIONAL_DEX_REVENANT_IMP,
    NATIONAL_DEX_REVENANT_DRAGON,
    NATIONAL_DEX_MALEDICTUS,
    NATIONAL_DEX_KALRAG,
    NATIONAL_DEX_ANIMAWHAL,
    NATIONAL_DEX_ANIMASAURUS,
    NATIONAL_DEX_SEA_TROLL_QUEEN,
    NATIONAL_DEX_YAK_LUMBER_FORM,
    NATIONAL_DEX_CABBAGE_SHATTERED_WORLD_FORM,
    NATIONAL_DEX_VULTURE_BEARDED_FORM,
    NATIONAL_DEX_KRYKET_BAT,
    NATIONAL_DEX_HAR_AKEN,
    NATIONAL_DEX_HAR_AKEN_TENTACLE,
    NATIONAL_DEX_SPIRIT_FIGHTER,
    NATIONAL_DEX_SPIRIT_ARCHER,
    NATIONAL_DEX_SPIRIT_MYSTIC,
    NATIONAL_DEX_SPIRIT_KNIGHT,
    NATIONAL_DEX_SPIRIT_SCOUT,
    NATIONAL_DEX_SPIRIT_WARMAGE,
    NATIONAL_DEX_POMAPOO,
    NATIONAL_DEX_JADINKO_MUTATED,
    NATIONAL_DEX_JADINKO_FEROCIOUS,
    NATIONAL_DEX_JADINKO_DRACONIC,
    NATIONAL_DEX_JADINKO_CARRION,
    NATIONAL_DEX_JADINKO_SHADOW,
    NATIONAL_DEX_JADINKO_GUTHIX,
    NATIONAL_DEX_JADINKO_ZAMORAK,
    NATIONAL_DEX_JADINKO_SARADOMIN,
    NATIONAL_DEX_MAX_GOLEM,
    NATIONAL_DEX_FLESH_CRAWLER,
    NATIONAL_DEX_ZYGOMITE_OSRS,
    NATIONAL_DEX_ZYGOMITE_OSRS_ANCIENT,
    NATIONAL_DEX_ZYGOMITE_RSHD_MUTATED,
    NATIONAL_DEX_ZYGOMITE_GLOOMSHROOM,
    NATIONAL_DEX_SNAIL,
    NATIONAL_DEX_ROCKSLUG_RSHD,
    NATIONAL_DEX_ROCKSLUG_OSRS,
    NATIONAL_DEX_SEASLUG,
    NATIONAL_DEX_SEASLUG_PRINCE,
    NATIONAL_DEX_SNAIL_GIANT_OSRS,
    NATIONAL_DEX_SNAIL_GIANT_RS3,
    NATIONAL_DEX_SNAIL_THORNY,
    NATIONAL_DEX_SNAIL_RAVENOUS,
    NATIONAL_DEX_SNAIL_BRUISE_OSRS,
    NATIONAL_DEX_SNAIL_BARK_OSRS,
    NATIONAL_DEX_SNAIL_BLOOD_RS3,
    NATIONAL_DEX_SNAIL_OCHRE_RS3,
    NATIONAL_DEX_SNAIL_MYRE_RS3,
    NATIONAL_DEX_MOTHER_MALLUM,
    NATIONAL_DEX_LAVA_DRAGON,
    NATIONAL_DEX_FROST_DRAGON,
    NATIONAL_DEX_DRAGON_CRYSTALLINE_FORM,
    NATIONAL_DEX_DRAGON_CORRUPTED_FORM,
    NATIONAL_DEX_SOTTLEPOT,
    NATIONAL_DEX_REANIMATED_DRAGON,
    NATIONAL_DEX_WHITE_DRAGON,
    NATIONAL_DEX_BRONZE_DRAGON,
    NATIONAL_DEX_IRON_DRAGON,
    NATIONAL_DEX_STEEL_DRAGON,
    NATIONAL_DEX_MITHRIL_DRAGON,
    NATIONAL_DEX_ADAMANT_DRAGON,
    NATIONAL_DEX_RUNE_DRAGON,
    NATIONAL_DEX_GALVEK,
    NATIONAL_DEX_CELESTIAL_DRAGON,
    NATIONAL_DEX_BANDOTRICE,
    NATIONAL_DEX_SERETRICE,
    NATIONAL_DEX_ZAROTRICE,
    NATIONAL_DEX_TUMETRICE,
    NATIONAL_DEX_UNGOTRICE,
    NATIONAL_DEX_ARMATRICE,
    NATIONAL_DEX_SPIRIT_COCKATRICE,
    NATIONAL_DEX_SEAGUTRICE,
    NATIONAL_DEX_COOCATRICE,
    NATIONAL_DEX_PHEATRICE,
    NATIONAL_DEX_MINI_MARM,
    NATIONAL_DEX_RICHIE,
    NATIONAL_DEX_CPT_MARLIN,
    NATIONAL_DEX_BARRELCHEST,
    NATIONAL_DEX_LAVA_BEAST,
    NATIONAL_DEX_LAVA_MONSTER,
    NATIONAL_DEX_ZOMBIE_HEAD,
    NATIONAL_DEX_WINTERTOAD,
    NATIONAL_DEX_PLAGUE_FROG,
    NATIONAL_DEX_SWAMP_FROG,
    NATIONAL_DEX_CUTHBERT,
    NATIONAL_DEX_ZORYA,
    NATIONAL_DEX_LOLA,
    NATIONAL_DEX_RABBIT_CAERBANNOG,
    NATIONAL_DEX_CHOCOLATE_RABBIT,
    NATIONAL_DEX_HARVEY,
    NATIONAL_DEX_EASTER_BUNNY,
    NATIONAL_DEX_WAR_BUNNY,
    NATIONAL_DEX_RABBIT_STALKER,
    NATIONAL_DEX_RABBIT_ELDER_STALKER,
    NATIONAL_DEX_CHICKEN_FRANK,
    NATIONAL_DEX_CHICKEN_DEATH,
    NATIONAL_DEX_CHICKEN_WAR,
    NATIONAL_DEX_CHICKEN_PESTILENCE,
    NATIONAL_DEX_CHICKEN_FAMINE,
    NATIONAL_DEX_FROGEEL_CRYSTALLINE,
    NATIONAL_DEX_FROGEEL_SEEKER,
    NATIONAL_DEX_FROGEEL_CORPOREAL,
    NATIONAL_DEX_FROGEEL_TZHAAR,
    NATIONAL_DEX_FROGEEL_ABYSSAL,
    NATIONAL_DEX_FROGEEL_REANIMATED,
    NATIONAL_DEX_FROGEEL_STRYKEWYRM,
    NATIONAL_DEX_FROGEEL_SNOW,
    NATIONAL_DEX_FROGEEL_TRIAL,
    NATIONAL_DEX_FROGEEL_MELEE,
    NATIONAL_DEX_FROGEEL_MAGIC,
    NATIONAL_DEX_FROGEEL_RANGED,
    NATIONAL_DEX_FROGEEL_SANE,
    NATIONAL_DEX_FROGEEL_PRINCE,
    NATIONAL_DEX_FROGEEL_PRINCESS,
    NATIONAL_DEX_CORRUPTED_BEAST,
    NATIONAL_DEX_MOLANISK,
    NATIONAL_DEX_DUCKATRICE,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_POKESCAPE == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_MOTHER_MALLUM
...
// Hoenn Pokédex order
//MUST HAVE SAME AMOUNT OF DEX ENTRIES AS POKEMON.C sHoennToNationalOrder
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_GUTHLING,
    HOENN_DEX_GUTHBIRD,
    ...
    HOENN_DEX_CHAMELEON,
    HOENN_DEX_BLOODVELD,
    HOENN_DEX_BLOODVELD_INSATIABLE_PHYSICAL,
    HOENN_DEX_BLOODVELD_RSHD,
    HOENN_DEX_BLOODVELD_MUTATED,
    HOENN_DEX_BLOODVELD_INSATIABLE_SPECIAL,
    HOENN_DEX_REAVER,
    HOENN_DEX_ARMALING,
    HOENN_DEX_ARMABIRD,
    ...
    HOENN_DEX_FLESH_SPOILER_COVERED_FORM,
    ...
    HOENN_DEX_TZTOK_JAD_HD_MEGA_FORM,
    HOENN_DEX_TZTOK_JAD_RS3_MEGA_FORM,
    HOENN_DEX_ABYSSAL_GUARDIAN,
    HOENN_DEX_SLIME_QUEEN,
    HOENN_DEX_AIRUT,
    HOENN_DEX_SKOTIZO,
    HOENN_DEX_SCURRIUS_MELEE_FORM,
    HOENN_DEX_SCURRIUS_RANGED_FORM,
    HOENN_DEX_SCURRIUS_MAGIC_FORM,
    HOENN_DEX_BROAV_ZOMBIE_FORM,
    HOENN_DEX_IMPLING_EASTER_FORM,
    HOENN_DEX_IMPLING_SNOW_FORM,
    HOENN_DEX_IMPLING_WANDERING_FORM,
    HOENN_DEX_IMPLING_GHOST_FORM,
    HOENN_DEX_VORKATH,
    HOENN_DEX_FOX_PYRE,
    HOENN_DEX_FOX_RECRUITMENTDRIVE,
    HOENN_DEX_FOX_FENNEC,
    HOENN_DEX_SALAMANDER_TECU,
    HOENN_DEX_JERBOA,
    HOENN_DEX_JERBOA_EMBERTAIL,
    HOENN_DEX_ANTELOPE_SUNLIGHT_FORM,
    HOENN_DEX_ANTELOPE_MOONLIGHT_FORM,
    HOENN_DEX_CAPYBARA,
    HOENN_DEX_CAPYBARA_ORANGE,
    HOENN_DEX_ENTLING,
    HOENN_DEX_PIGGLES,
    HOENN_DEX_WOLPERTINGER_MEGA_FORM,
    HOENN_DEX_FLESH_SPOILER_NAKED_FORM,
    HOENN_DEX_FLESH_SPOILER_SPAWNLING,
    HOENN_DEX_CAUSTIC_GAZER,
    HOENN_DEX_IRIS_STALKER,
    HOENN_DEX_ANIMATED_BOOK,
    HOENN_DEX_TOME_OF_STRENGTH,
    HOENN_DEX_TOME_OF_RANGED,
    HOENN_DEX_TOME_OF_MAGIC,
    HOENN_DEX_LUMINESCENT_ICEFIEND,
    HOENN_DEX_WARPED_GALUGA,
    HOENN_DEX_SUBMASTYX,
    HOENN_DEX_PARAMASTYX,
    HOENN_DEX_ARCHAEMASTYX,
    HOENN_DEX_DROMOMASTYX,
    HOENN_DEX_SPINOMASTYX,
    HOENN_DEX_GALLIMASTYX,
    HOENN_DEX_STEGOMASTYX,
    HOENN_DEX_MEGAMASTYX,
    HOENN_DEX_JELLY_ALTERNATE_FORM,
    HOENN_DEX_JELLY_DUNGEONEERING_FORM,
    HOENN_DEX_JELLY_TROLLWEISS_FORM,
    HOENN_DEX_JELLY_VITREOUS_FORM,
    HOENN_DEX_JELLY_WARPED_VITREOUS_FORM,
    HOENN_DEX_MOTH_SUNLIGHT_FORM,
    HOENN_DEX_MOTH_MOONLIGHT_FORM,
    HOENN_DEX_STONE_OF_JAS_MEGA_FORM,
    HOENN_DEX_SPIRIT_WARRIOR,
    HOENN_DEX_SPIRIT_RANGER,
    HOENN_DEX_SPIRIT_MAGE,
    HOENN_DEX_ESSLING,
    HOENN_DEX_ESSHOUND,
    HOENN_DEX_ESSWRAITH,
    HOENN_DEX_HARPY_EAGLE,
    HOENN_DEX_REBORN_WARRIOR,
    HOENN_DEX_REBORN_RANGER,
    HOENN_DEX_REBORN_MAGE,
    HOENN_DEX_JAGUAR_ORANGE_FORM,
    HOENN_DEX_JAGUAR_BLACK_FORM,
    HOENN_DEX_TORTLE,
    HOENN_DEX_COCKATRICE_OSRS_FORM,
    HOENN_DEX_COCKATHRICE,
    HOENN_DEX_COCKATRICE_MOONLIGHT,
    HOENN_DEX_REVENANT_IMP,
    HOENN_DEX_REVENANT_DRAGON,
    HOENN_DEX_MALEDICTUS,
    HOENN_DEX_KALRAG,
    HOENN_DEX_ANIMAWHAL,
    HOENN_DEX_ANIMASAURUS,
    HOENN_DEX_SEA_TROLL_QUEEN,
    HOENN_DEX_YAK_LUMBER_FORM,
    HOENN_DEX_CABBAGE_SHATTERED_WORLD_FORM,
    HOENN_DEX_VULTURE_BEARDED_FORM,
    HOENN_DEX_KRYKET_BAT,
    HOENN_DEX_HAR_AKEN,
    HOENN_DEX_HAR_AKEN_TENTACLE,
    HOENN_DEX_SPIRIT_FIGHTER,
    HOENN_DEX_SPIRIT_ARCHER,
    HOENN_DEX_SPIRIT_MYSTIC,
    HOENN_DEX_SPIRIT_KNIGHT,
    HOENN_DEX_SPIRIT_SCOUT,
    HOENN_DEX_SPIRIT_WARMAGE,
    HOENN_DEX_POMAPOO,
    HOENN_DEX_JADINKO_MUTATED,
    HOENN_DEX_JADINKO_FEROCIOUS,
    HOENN_DEX_JADINKO_DRACONIC,
    HOENN_DEX_JADINKO_CARRION,
    HOENN_DEX_JADINKO_SHADOW,
    HOENN_DEX_JADINKO_GUTHIX,
    HOENN_DEX_JADINKO_ZAMORAK,
    HOENN_DEX_JADINKO_SARADOMIN,
    HOENN_DEX_MAX_GOLEM,
    HOENN_DEX_FLESH_CRAWLER,
    HOENN_DEX_ZYGOMITE_OSRS,
    HOENN_DEX_ZYGOMITE_OSRS_ANCIENT,
    HOENN_DEX_ZYGOMITE_RSHD_MUTATED,
    HOENN_DEX_ZYGOMITE_GLOOMSHROOM,
    HOENN_DEX_SNAIL,
    HOENN_DEX_ROCKSLUG_RSHD,
    HOENN_DEX_ROCKSLUG_OSRS,
    HOENN_DEX_SEASLUG,
    HOENN_DEX_SEASLUG_PRINCE,
    HOENN_DEX_SNAIL_GIANT_OSRS,
    HOENN_DEX_SNAIL_GIANT_RS3,
    HOENN_DEX_SNAIL_THORNY,
    HOENN_DEX_SNAIL_RAVENOUS,
    HOENN_DEX_SNAIL_BRUISE_OSRS,
    HOENN_DEX_SNAIL_BARK_OSRS,
    HOENN_DEX_SNAIL_BLOOD_RS3,
    HOENN_DEX_SNAIL_OCHRE_RS3,
    HOENN_DEX_SNAIL_MYRE_RS3,
    HOENN_DEX_MOTHER_MALLUM,
    HOENN_DEX_LAVA_DRAGON,
    HOENN_DEX_FROST_DRAGON,
    HOENN_DEX_DRAGON_CRYSTALLINE_FORM,
    HOENN_DEX_DRAGON_CORRUPTED_FORM,
    HOENN_DEX_SOTTLEPOT,
    HOENN_DEX_REANIMATED_DRAGON,
    HOENN_DEX_WHITE_DRAGON,
    HOENN_DEX_BRONZE_DRAGON,
    HOENN_DEX_IRON_DRAGON,
    HOENN_DEX_STEEL_DRAGON,
    HOENN_DEX_MITHRIL_DRAGON,
    HOENN_DEX_ADAMANT_DRAGON,
    HOENN_DEX_RUNE_DRAGON,
    HOENN_DEX_GALVEK,
    HOENN_DEX_CELESTIAL_DRAGON,
    HOENN_DEX_BANDOTRICE,
    HOENN_DEX_SERETRICE,
    HOENN_DEX_ZAROTRICE,
    HOENN_DEX_TUMETRICE,
    HOENN_DEX_UNGOTRICE,
    HOENN_DEX_ARMATRICE,
    HOENN_DEX_SPIRIT_COCKATRICE,
    HOENN_DEX_SEAGUTRICE,
    HOENN_DEX_COOCATRICE,
    HOENN_DEX_PHEATRICE,
    HOENN_DEX_MINI_MARM,
    HOENN_DEX_RICHIE,
    HOENN_DEX_CPT_MARLIN,
    HOENN_DEX_BARRELCHEST,
    HOENN_DEX_LAVA_BEAST,
    HOENN_DEX_LAVA_MONSTER,
    HOENN_DEX_ZOMBIE_HEAD,
    HOENN_DEX_WINTERTOAD,
    HOENN_DEX_PLAGUE_FROG,
    HOENN_DEX_SWAMP_FROG,
    HOENN_DEX_CUTHBERT,
    HOENN_DEX_ZORYA,
    HOENN_DEX_LOLA,
    HOENN_DEX_RABBIT_CAERBANNOG,
    HOENN_DEX_CHOCOLATE_RABBIT,
    HOENN_DEX_HARVEY,
    HOENN_DEX_EASTER_BUNNY,
    HOENN_DEX_WAR_BUNNY,
    HOENN_DEX_RABBIT_STALKER,
    HOENN_DEX_RABBIT_ELDER_STALKER,
    HOENN_DEX_CHICKEN_FRANK,
    HOENN_DEX_CHICKEN_DEATH,
    HOENN_DEX_CHICKEN_WAR,
    HOENN_DEX_CHICKEN_PESTILENCE,
    HOENN_DEX_CHICKEN_FAMINE,
    HOENN_DEX_FROGEEL_CRYSTALLINE,
    HOENN_DEX_FROGEEL_SEEKER,
    HOENN_DEX_FROGEEL_CORPOREAL,
    HOENN_DEX_FROGEEL_TZHAAR,
    HOENN_DEX_FROGEEL_ABYSSAL,
    HOENN_DEX_FROGEEL_REANIMATED,
    HOENN_DEX_FROGEEL_STRYKEWYRM,
    HOENN_DEX_FROGEEL_SNOW,
    HOENN_DEX_FROGEEL_TRIAL,
    HOENN_DEX_FROGEEL_MELEE,
    HOENN_DEX_FROGEEL_MAGIC,
    HOENN_DEX_FROGEEL_RANGED,
    HOENN_DEX_FROGEEL_SANE,
    HOENN_DEX_FROGEEL_PRINCE,
    HOENN_DEX_FROGEEL_PRINCESS,
    HOENN_DEX_CORRUPTED_BEAST,
    HOENN_DEX_MOLANISK,
    HOENN_DEX_DUCKATRICE,
};

#define HOENN_DEX_COUNT (NATIONAL_DEX_MOTHER_MALLUM + 1)
