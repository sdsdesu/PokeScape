...
const u8 gText_Pokedex[] = _("BESTIARY"); // Unused
...
*/
const u8 gText_DefaultNameScapes[] = _("SCAPES");
const u8 gText_DefaultNameScaper[] = _("SCAPER");

const u8 gText_ThisIsAPokemon[] = _("This is what we call a “MONSTER.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? MONSTER");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? lbs.");
const u8 gText_EmptyPkmnCategory[] = _("                       MONSTER"); // Unused
...
const u8 gText_PokedexRegistration[] = _("BESTIARY registration completed.");
...
const u8 gText_SwitchPokedexListings[] = _("Switch BESTIARY listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the BESTIARY.");
const u8 gText_SelectPokedexMode[] = _("Select the BESTIARY mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the BESTIARY listing mode.");
...
const u8 gText_DexHoennDescription[] = _("F2P BESTIARY");
const u8 gText_DexNatDescription[] = _("GIELINORIAN BESTIARY");
...
const u8 gText_NoPokemon[] = _("There are no\nMONSTERS.");
...
const u8 gText_BootedUpTM[] = _("Opened a scroll.");
const u8 gText_BootedUpHM[] = _("Opened a scroll.");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with this MON?");
...
const u8 gText_NoPokemonForBattle[] = _("No MONSTER for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a MONSTER.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} MONSTER are needed.");
const u8 gText_PokemonCantBeSame[] = _("MONSTER can't be the same.");
...
const u8 gText_RentalPkmn[] = _("RENTAL MONSTERS");
...
const u8 gText_MenuOptionPokedex[] = _("BESTIARY");
const u8 gText_MenuOptionPokemon[] = _("MONSTER");
...
const u8 gText_PokemonJump[] = _("MONSTER JUMP");
...
const u8 gText_PyramidPokemon[] = _("PYRAMID: MONSTER");
...
const u8 gText_PokemonOrder[] = _("MONSTER ORDER");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this MONSTER?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your MONSTER.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last MONSTER!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a MONSTER!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a MONSTER?");
...
const u8 gPCText_Scenery1[] = _("GODS 1");
const u8 gPCText_Scenery2[] = _("GODS 2");
const u8 gPCText_Scenery3[] = _("GODS 3");
const u8 gPCText_Etcetera[] = _("ETCETERA");
const u8 gPCText_Friends[] = _("FRIENDS");
const u8 gPCText_Forest[] = _("GUTHIX");
const u8 gPCText_City[] = _("ZAMORAK");
const u8 gPCText_Desert[] = _("SARADOMIN");
const u8 gPCText_PokeScape_1[] = _("STARTERS");
const u8 gPCText_Savanna[] = _("BANDOS");
const u8 gPCText_Crag[] = _("ARMADYL");
const u8 gPCText_Volcano[] = _("TUMEKEN");
const u8 gPCText_Snow[] = _("STARTERS");
const u8 gPCText_Cave[] = _("ZAROS");
const u8 gPCText_Beach[] = _("SEREN");
const u8 gPCText_Seafloor[] = _("GODLESS");
const u8 gPCText_River[] = _("STARTERS");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW MONSTER");
const u8 gText_DepositPokemon[] = _("DEPOSIT MONSTER");
const u8 gText_MovePokemon[] = _("MOVE MONSTER");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move MONSTER stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store MONSTER in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the MONSTER in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any MONSTER\nin a BOX or your party.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party MONSTER in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all MONSTER in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the POKéNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool MONSTER.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful MONSTER.");
const u8 gText_FindCutePokemon[] = _("Find cute MONSTER.");
const u8 gText_FindSmartPokemon[] = _("Find smart MONSTER.");
const u8 gText_FindToughPokemon[] = _("Find tough MONSTER.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S MONSTER");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL MONSTER.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various MONSTERS.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better MONSTER");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any MONSTER!");
const u8 gText_MatchCallMay_Intro1[] = _("My MONSTERS and I help");
...
const u8 gText_ContinueMenuPokedex[] = _("BESTIARY");
...
const u8 gText_MenuPokedex[] = _("BESTIARY");
...
const u8 gText_DexHoenn[] = _("F2P");
const u8 gText_DexNational[] = _("GIELINORIAN");
...
const u8 gText_Gielinor[] = _("GIELINOR");
const u8 gText_OhABite[] = _("Oh! Something is snagged!");
const u8 gText_PokemonOnHook[] = _("A MONSTER's caught in the net!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SubQuest_QuestPowerPlantScorpions_Desc1[] = _("You accepted the quest to get\nrid of some scorpions.");
const u8 gText_SubQuest_QuestPowerPlantScorpions_Name2[] = _("Access granted!");
const u8 gText_SubQuest_QuestPowerPlantScorpions_Desc2[] = _("Using the Factory Key you\ngained access to the powerplant.");
const u8 gText_SubQuest_QuestPowerPlantScorpions_Name3[] = _("Did someone call for a hairdresser?");
const u8 gText_SubQuest_QuestPowerPlantScorpions_Desc3[] = _("You defeated some massive\nscorpions!");
...
const u8 gText_SubQuest1_Name4[] = _("Jatizso - Jackie & BonBun");
const u8 gText_SubQuest1_Name5[] = _("Jatizso - ???");
const u8 gText_SubQuest1_Name6[] = _("Jatizso - Moggie");
const u8 gText_SubQuest1_Name7[] = _("Jatizso - ???");
const u8 gText_SubQuest1_Name8[] = _("Neitiznot - Part 8");
...
const u8 gText_SubQuest1_Desc1[] = _("You recruited Elej\nfor the Art Fight.");//_("Assist Elej in a search around Jatizso\nfor the ideal photo spot.");
const u8 gText_SubQuest1_Desc2[] = _("You recruited Madame Dragon\nfor the Art Fight.");
const u8 gText_SubQuest1_Desc3[] = _("You recruited Bats\nfor the Art Fight.");
const u8 gText_SubQuest1_Desc4[] = _("You recruited Jackie & BonBun\nfor the Art Fight.");
const u8 gText_SubQuest1_Desc5[] = _("You recruited ???\nfor the Art Fight.");
const u8 gText_SubQuest1_Desc6[] = _("You recruited Moggie\nfor the Art Fight.");
const u8 gText_SubQuest1_Desc7[] = _("You successfully turned and\nrecruited ???\nfor the Art Fight.");
...
const u8 gText_Follower[] = _("EVOLVE WILD MONS");
...
const u8 gText_DifficultyEasy[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1");
const u8 gText_DifficultyNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2");
const u8 gText_DifficultyHard[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3");
const u8 gText_OpenWorldOptionsMenu[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OPEN WORLD OPTIONS");
...
const u8 gText_DarkTotemTop[] = _("DARK TOTEM{CLEAR_TO 0x5E}100 SP");
const u8 gText_DarkTotemTop_SALE[] = _("DARK TOTEM{CLEAR_TO 0x5E}50 SP");
const u8 gText_DarkTotemTop_Desc[] = _("The top piece of a Dark Totem.");
const u8 gText_DarkTotemMiddle[] = _("DARK TOTEM{CLEAR_TO 0x5E}100 SP");
const u8 gText_DarkTotemMiddle_SALE[] = _("DARK TOTEM{CLEAR_TO 0x5E}50 SP");
const u8 gText_DarkTotemMiddle_Desc[] = _("The middle piece of a Dark Totem.");
const u8 gText_DarkTotemBottom[] = _("DARK TOTEM{CLEAR_TO 0x5E}100 SP");
const u8 gText_DarkTotemBottom_SALE[] = _("DARK TOTEM{CLEAR_TO 0x5E}50 SP");
const u8 gText_DarkTotemBottom_Desc[] = _("The bottom piece of a Dark Totem.");
const u8 gText_AncientShard[] = _("ANCIENT SHARD{CLEAR_TO 0x5E}6 SP");
const u8 gText_AncientShard_Desc[] = _("An ancient Shard.");
const u8  gText_Overload [] = _("OVERLOAD{CLEAR_TO 0x5E}48 SP");
...
const u8 gText_ElementalShield [] = _("ELEMENTAL SHIELD{CLEAR_TO 0x5E}48 SP");
const u8 gText_GraniteMaul [] = _("GRANITE MAUL{CLEAR_TO 0x5E}48 SP");
const u8 gText_KrakenTentacle [] = _("KRAKEN TENTACLE{CLEAR_TO 0x5E}48 SP");
const u8 gText_Overload_Desc [] = _("Increases the power of moves\nbut drains life.");
