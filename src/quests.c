...
static const u8 sText_AllHeader[] = _("Quest List");
static const u8 sText_InactiveHeader[] = _("Not Started Quests");
static const u8 sText_ActiveHeader[] = _("Started Quests");
...
static const u8 sText_StartForMore[] =
      _("You have yet to start this quest.");
...
{
	u8 mode = sStateDataPtr-> filterMode % 10;
	u8 /*lastRow = 0,8*/ numRow = 0, offset = 0, newRow = 0, countQuest = 0,
	   selectedQuestId = 0;
	u8 *sortedQuestList;
...
static void ManageFavorites(u8 selectedQuestId)
{
	if (QuestMenu_GetSetQuestState(selectedQuestId, FLAG_GET_FAVORITE))
	{
