...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SOAK] = _("Soak"),
    [MOVE_FLAME_CHARGE] = _("Nitro Charge"),
    [MOVE_COIL] = _("Coil"),
    ...
    [MOVE_TELE_BLOCK] = _("Tele-Block"),
    [MOVE_DRAGONFIRE] = _("Dragonfire"),
    [MOVE_SILVERLIGHT] = _("Silverlight"),
    [MOVE_DARKLIGHT] = _("Darklight"),
    [MOVE_ARCLIGHT] = _("Arclight"),
    [MOVE_EMBERLIGHT] = _("Emberlight"),
    [MOVE_IBAN_BLAST] = _("Iban Blast"),
    [MOVE_LIQUEFY] = _("Liquefy"),
    [MOVE_CONFUSE] = _("Confuse"),
    [MOVE_ANALYSE] = _("Analyse"),
    [MOVE_ALCHEMY] = _("Alchemy"),
    [MOVE_SNARE] = _("Snare"),
    [MOVE_ENTANGLE] = _("Entangle"),
    [MOVE_PUNCTURE] = _("Puncture"),
    [MOVE_ICE_RUSH] = _("Ice Rush"),
    [MOVE_ICE_BURST] = _("Ice Burst"),
    [MOVE_ICE_BLITZ] = _("Ice Blitz"),
    [MOVE_BLOOD_RUSH] = _("Blood Rush"),
    [MOVE_BLOOD_BURST] = _("Blood Burst"),
    [MOVE_BLOOD_BLITZ] = _("Blood Blitz"),
    [MOVE_SMOKE_RUSH] = _("Smoke Rush"),
    [MOVE_SMOKE_BURST] = _("Smoke Burst"),
    [MOVE_SMOKE_BLITZ] = _("Smoke Blitz"),
    [MOVE_SHADOW_RUSH] = _("Shadow Rush"),
    [MOVE_SHADOW_BURST] = _("Shadow Burst"),
    [MOVE_SHADOW_BLITZ] = _("Shadow Blitz"),
    [MOVE_CURE_GROUP] = _("Cure Group"),
    [MOVE_SMITE] = _("Smite"),
    [MOVE_RETRIBUTION] = _("Retribution"),
    [MOVE_MISCHIEF] = _("Mischief"),
    [MOVE_RODENT_BITE] = _("Rodent Bite"),
    [MOVE_CALL_TO_ARMS] = _("Call to Arms"),
    [MOVE_PETRIFYING_GAZE] = _("Petrifying Gaze"),
    [MOVE_WIND_STRIKE] = _("Wind Strike"),
    [MOVE_WIND_BLAST] = _("Wind Blast"),
    [MOVE_WIND_WAVE] = _("Wind Wave"),
    [MOVE_WIND_SURGE] = _("Wind Surge"),
    [MOVE_CRUMBLE_UNDEAD] = _("Crumble Undead"),
    [MOVE_CURE_PLANT] = _("Cure Plant"),
    [MOVE_BACON_BLAST] = _("Bacon Blast"),
    [MOVE_TITANS_CONSTITUTION] = _("Titans Const"),
    [MOVE_CONSPIRACY] = _("Conspiracy"),
    [MOVE_COMMITTEE_STRIKE] = _("Committee Strike"),
    [MOVE_CARAPACE_HARDEN] = _("Carapace Harden"),
    [MOVE_SHARKBREW] = _("Sharkbrew"),
