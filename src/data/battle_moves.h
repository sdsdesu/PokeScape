...
//PokeScape Moves
    ...
    [MOVE_ALCHEMY] =
    {
        .effect = EFFECT_PAY_DAY, //todo otherwise for now it can be an attacking move.
        .power = 30,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 30,
    ...
    {
        .effect = EFFECT_SPEED_DOWN_2, //I know EFFECT_SPEED_DOWN_2 works but am unsure whether this works in conjunction with HIT? EFFECT_SPEED_DOWN_2_HIT
	    .power = 60,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 20,
    ...
    [MOVE_SNELM_SHOWOFF] =
    {
        ...
        .pp = 20,
        .secondaryEffectChance = 0, //NEEDS UPDATING WHEN EFFECT ADDED
        .target = MOVE_TARGET_USER, //MAY NEED UPDATING AS IT AFFECTS BOTH USER AND TARGET?
        .priority = 0,
        .split = SPLIT_STATUS,
        .zMoveEffect = Z_EFFECT_NONE,
    },
