...
const u8 *const gItemEffectTable[ITEMS_COUNT] =
{
    ...
    [ITEM_PURPLE_SWEETS]      = gItemEffect_RareCandy,
    ...
    //pokescape 
    // Evolution Items
    [ITEM_AIR_RUNE]		                = gItemEffect_EvoItem,
    [ITEM_WATER_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_EARTH_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_FIRE_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_MIND_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_BODY_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_LAW_RUNE]		                = gItemEffect_EvoItem,
    [ITEM_NATURE_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_CHAOS_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_COSMIC_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_BLOOD_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_SOUL_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_DEATH_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_MUD_RUNE]		                = gItemEffect_EvoItem,
    [ITEM_MIST_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_LAVA_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_DUST_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_ASTRAL_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_LIFE_RUNE]		            = gItemEffect_EvoItem,
    [ITEM_SPIRIT_CHARM]		            = gItemEffect_EvoItem,
    [ITEM_LEGENDARY_ITEM]               = gItemEffect_EvoItem,
    [ITEM_BAD_EGG]		                = gItemEffect_EvoItem,
    [ITEM_SHRIVELLED_DAGANNOTH_CLAW]    = gItemEffect_EvoItem,
    [ITEM_DAGANNOTH_EGG_SHELL]		    = gItemEffect_EvoItem,
    [ITEM_DAGANNOTH_SCALE]              = gItemEffect_EvoItem,
    [ITEM_NUMBLING_ROOT]                = gItemEffect_EvoItem,
    [ITEM_SOCK]		                    = gItemEffect_EvoItem,
    [ITEM_TEAR_OF_GUTHIX]               = gItemEffect_EvoItem,
    ...
    [ITEM_EASTER_EGG]                   = gItemEffect_MaxRevive,
    //[ITEM_FRESH_WATER]                = gItemEffect_FreshWater,
    //[ITEM_SODA_POP]                   = gItemEffect_SodaPop,
    //[ITEM_LEMONADE]                   = gItemEffect_Lemonade,
    //[ITEM_MOOMOO_MILK]                = gItemEffect_MoomooMilk,
    ...
    //[ITEM_HEAL_POWDER]                = gItemEffect_HealPowder,
    //[ITEM_REVIVAL_HERB]               = gItemEffect_RevivalHerb,
    [ITEM_CHOCOLATE_SUNDAY]             = gItemEffect_Antidote,
    [ITEM_FRUIT_BLAST]                  = gItemEffect_ParalyzeHeal,
    [ITEM_DRUNK_DRAGON]                 = gItemEffect_BurnHeal,
    [ITEM_WIZARDS_BLIZZARD]             = gItemEffect_IceHeal,
    [ITEM_PINEAPPLE_PUNCH]              = gItemEffect_Awakening,
    [ITEM_BLUEBERRY_SPECIAL]            = gItemEffect_FullHeal,
    [ITEM_PRAYER_POTION]                = gItemEffect_Ether,
    [ITEM_SUPER_PRAYER_POTION]          = gItemEffect_MaxEther,
    //[ITEM_ELIXIR]                     = gItemEffect_Elixir,
    //[ITEM_MAX_ELIXIR]                 = gItemEffect_MaxElixir,
    //[ITEM_BERRY_JUICE]                = gItemEffect_BerryJuice,
    ...
    // Vitamins
    [ITEM_LAMP_HP]                  = gItemEffect_HPUp,
    [ITEM_LAMP_ATT]                 = gItemEffect_Protein,
    [ITEM_LAMP_DEF]                 = gItemEffect_Iron,
    [ITEM_LAMP_SPATT]               = gItemEffect_Calcium,
    [ITEM_LAMP_SPDEF]               = gItemEffect_Zinc,
    [ITEM_LAMP_SPEED]               = gItemEffect_Carbos,
    [ITEM_STAT_BEER]                = gItemEffect_PPUp,
    [ITEM_STAT_MOONLIGHT_MEAD]      = gItemEffect_PPMax,
