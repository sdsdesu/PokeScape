...
#define SOUND_LIST_BGM \
	X(MUS_PS_TITLESCREEN) \
	X(MUS_PS_BANK) \
	X(MUS_PS_GENERAL_STORE) \
	X(MUS_PS_PUB) \
	X(MUS_PS_CHURCH) \
	X(MUS_PS_GYM) \
	X(MUS_PS_FOREST_F2P) \
	...
	X(MUS_PS_ROUTE_PORT_SARIM) \
	X(MUS_PS_ROUTE_RIMMINGTON) \
	X(MUS_PS_ROUTE_ASGARNIA) \
	X(MUS_PS_ROUTE_MISTHALIN) \
	X(MUS_PS_ROUTE_DESERT) \
	X(MUS_PS_ROUTE_KARAMJA) \
	X(MUS_PS_ROUTE_WILDERNESS) \
	X(MUS_PS_VICTORY_ROAD) \
	X(MUS_PS_VS_WILD_F2P) \
	X(MUS_PS_VS_WILD_P2P) \
	X(MUS_PS_VS_TRAINER_F2P) \
	X(MUS_PS_VS_TRAINER_P2P) \
	X(MUS_PS_VS_GYM) \
	X(MUS_PS_VS_HAM) \
	X(MUS_PS_VS_KNIGHTS) \
	X(MUS_PS_VS_ELITE4) \
	X(MUS_PS_VS_LEGENDARY) \
	X(MUS_PS_VS_CHAOS_ELEMENTAL) \
	X(MUS_PS_VS_POKESCAPERS) \
	X(MUS_PS_VS_DEMONHEADGE) \
	X(MUS_PS_VS_ORCHY) \
	X(MUS_PS_ENCOUNTER_NOOB) \
	X(MUS_PS_ENCOUNTER_SKILLER) \
	X(MUS_PS_ENCOUNTER_PKER) \
	X(MUS_PS_ENCOUNTER_KNIGHTS) \
	X(MUS_PS_ENCOUNTER_HAM) \
	X(MUS_PS_ENCOUNTER_GYM) \
	X(MUS_PS_ENCOUNTER_LEGENDARY) \
	X(MUS_PS_ENCOUNTER_SPECIAL) \
	X(MUS_PS_ENCOUNTER_MITHRILMAN) \
	X(MUS_PS_QUEST_COMPLETE) \
	X(MUS_PS_KOUREND_CATACOMBS) \
	X(MUS_PS_TRAINER_VICTORY) \
	X(MUS_PS_VS_CHAOS_TUNNELS) \
	X(MUS_PS_WISE_OLD_MAN_THEME) \
